...
<body>
    ...
    <section class="main" style="background-image: url(images/amrita-hero.jpeg); height:100vh;">
        
        <nav>
            <a href="#" class="logo">
                <img src="https://upload.wikimedia.org/wikipedia/en/f/f8/Amrita-vishwa-vidyapeetham-color-logo.png" class="image1" width="320px" />
        ...
        <div class="home-content">
            ...
            <div class="home-text" >
                ...
                <h3 style="color: white; letter-spacing: 3px;">Welcome to Amrita College :)</h3>
                <h1 style="color: white;"> Student Portal</h1>
                <p style="color: white;">Amrita college provides a student centre of learning environment with close student faculty interaction and constant participation. The Principal mission of our college is to achieve success.</p>
            <!--login-btn-->
            <a href="user/signup.php" class="main-login" style="border-radius: 5px;">Apply Now</a>
            </div>
            <!--img-->
            <div class="home-img" style="width: 160px;">
                <img src="images/hero.png" width="300px"  style="text-shadow: 20px 22px;"/>
