...
<li class=" nav-item"><a href="addmission-form.php"><i class="la la-chevron-circle-right"></i><span class="menu-title" data-i18n="nav.dash.main">Addmission Form</span></a>
        </li>
